          ...
          cartData.map((item,index)=>{
            ...
            return(
              <div key={index} className='py-4 border-t border-b text-gray-700 grid grid-col-[4fr_0.5fr_0.5fr] sm:grid-cols-[4fr_2fr_0.5fr] items-center gap-4'>
                ...
                <input onClick={(e)=>{e.target.value==='' || e.target.value==='0' ?null : updateQuantity(item._id, item.size, Number(e.target.value))}} className='border max-w-10 sm:max-w-20 px-1 sm:px-2 py-1' type="number" min={1} max={50} defaultValue={item.quantity} />
